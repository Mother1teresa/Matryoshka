        ...
        t.a = function(e2, t2) {
          ...
          e2.oninput = function(t3) {
            if (t3.isTrusted) {
              ...
              for (e2.value = n.i(a.a)(e2.value, o2.mask, true, o2.tokens); i2 < e2.value.length && e2.value.charAt(i2 - 1) !== u2; ) i2++;
        ...
        function r(e2, t2, n2) {
          return t2 = t2.sort(function(e3, t3) {
            ...
            for (var o = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2], i = 0; i < t2.length; ) {
              ...
              i++;
              var s = t2[i];
              if (!(s && e2(r2, s, true, n2).length > u.length)) return e2(r2, u, o, n2);
            }
            return "";
          };
        }
